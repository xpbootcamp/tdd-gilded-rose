...
public class BackstagePassTest {
    ...
    @Test
    public void should_quality_increase_by_3_and_sellIn_decrease_by_1_when_update_given_sellIn_below_5_and_quality_is_below_48() {
        double oldQuality = 45;
        int oldSellIn = 1;
    ...
    @Test
    public void should_quality_is_50_and_sellIn_decrease_by_1_when_update_given_sellIn_below_5_and_quality_is_48() {
    ...
    @Test
    public void should_quality_is_0_and_sellIn_decrease_by_1_when_update_given_out_sellIn() {
        double oldQuality = 25;
        int oldSellIn = 0;
